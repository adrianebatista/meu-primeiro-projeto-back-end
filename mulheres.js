...
const conectaBancoDeDados = require('./bancoDeDados') //concectando ao arquivo o banco de dados
conectaBancoDeDados() //chamando a função que conecta o banco de dados

const Mulher = require('./mulherModel') //conectando com o modelo de criação do objeto mulher
